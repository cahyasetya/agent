...
def search_files(search_path: str = ".", file_pattern: str = "*"):
    """
    ...
    """
    print(
        f"--- TOOL EXECUTING: search_files(search_path='{search_path}', file_pattern='{file_pattern}') ---"
    )
    try:
        ...
        found_files = []
        for root, _, files in os.walk(resolved_search_path):
